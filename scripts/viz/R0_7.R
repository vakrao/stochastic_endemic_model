...
ggsave("/N/project/endemic_covid/data/raw/R0/R0_7/viz/rt_R0_7.png", 
       type="cairo", 
       height=7,
       width=9,
       units = "in",
...
ggsave("/N/project/endemic_covid/data/raw/R0/R0_7/viz/age_diff_R0_7.png", 
       type="cairo", 
       height=7,
       width=10,
       units = "in",
...
ggsave("/N/project/endemic_covid/data/raw/R0/R0_7/viz/heat_maps_deaths_R0_7.png", 
       type="cairo", 
       height=8,
       width=10,
       units = "in",
...
ggsave("/N/project/endemic_covid/data/raw/R0/R0_7/viz/heat_maps_infections_R0_7.png", 
       type="cairo", 
       height=8,
       width=10,
       units = "in",
